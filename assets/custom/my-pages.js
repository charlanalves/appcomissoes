class LoadPage {
    ...
    vendas(page) {
        ...
        // empresas + periodos
        var templateFiltro = new Template('templateFiltro');
        templateFiltro.compileAjax('vendas-filter', locaStorage, function () {
            // carrega a lista apos gerar os filtros de empresa e periodo
            findVendas();
            // cria evento de clique no botao de busca de de vendas
            $('a#btn-filtrar').on('click', function () {
                findVendas();
            });
        });
    }
